    ...
    <div className="space-y-3 text-xs">
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex gap-2">
          <span className="text-pip shrink-0">▸</span>
          <span className="text-pip leading-relaxed">
            <span className="text-amber font-bold">Campaign state is shared.</span> Round number and battle count sync live across all players instantly.
          </span>
        </div>
        <div className="flex gap-2">
          <span className="text-pip shrink-0">▸</span>
...
const ALL_STEPS = [
  ...
  },
  {
    ...
    placement: 'below',
    title: 'CAMPAIGN TAB',
    body: 'Shared across all players. Track the current round and battle count. When the campaign creator advances to the next round, everything resets automatically — units rest, structure uses clear, unavailable units return when applicable, boost hands return to the recovery pool, and item pools update.',
  },
  {
    id: 'homestead',
