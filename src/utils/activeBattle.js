...
export function normalizeActiveBattle(raw) {
  ...
  return {
    ...
    battleStartedBy: raw.battleStartedBy && typeof raw.battleStartedBy === 'object' && !Array.isArray(raw.battleStartedBy) ? raw.battleStartedBy : {},
    battleEndedBy: raw.battleEndedBy && typeof raw.battleEndedBy === 'object' && !Array.isArray(raw.battleEndedBy) ? raw.battleEndedBy : {},
